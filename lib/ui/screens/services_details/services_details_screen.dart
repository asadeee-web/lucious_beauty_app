...
import 'package:lucious_beauty_app/ui/screens/book_appointment/book_appointment.dart';
import 'package:lucious_beauty_app/ui/screens/services_details/services_view_model.dart';
...
class ServicesDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ServicesDetailViewModel(),
      child:
          Consumer<ServicesDetailViewModel>(builder: (context, model, child) {
        return Scaffold(
          body: SizedBox(
